...
import { styles } from "./register-passenger.style.js";
import icons from "../../constants/icons.js";
import { useState, useRef, useEffect } from "react";
import AsyncStorage from '@react-native-async-storage/async-storage';
import { api, HandleError } from "../../constants/api.js";

function RegisterPassenger(props) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.logoContainer}>
                    ...
                    <Text style={styles.appSubtitle}>CADASTRO DE PASSAGEIRO</Text>
                </View>
            </View>
            ...
            >
                <View style={styles.formContainer}>
                    <Text style={styles.formTitle}>Criar conta de passageiro</Text>
                ...
                <Animated.View style={[styles.modalOverlay, { opacity: fadeAnim }]}>
                    ...
                    >
                        ...
                        <Text style={styles.successMessage}>
                            Conta de passageiro criada com sucesso!
                        </Text>
                        <TouchableOpacity 
